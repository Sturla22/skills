...
- The project-level risk catalog lives at `docs/risks.md`. Use `templates/risk-catalog-template.md`.
...
- Run `python scripts/cli.py check-risks` to verify all cataloged risks have test-proven mitigations.
